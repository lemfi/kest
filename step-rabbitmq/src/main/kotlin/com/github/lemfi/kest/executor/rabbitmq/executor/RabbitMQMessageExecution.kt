...
data class RabbitMQMessageExecution(
    ...
    override fun execute() {
        ...
        if (rabbitMQSnifferProp.active && rabbitMQSnifferProp.startedByKest) startRabbitMQProxy(user, password, host, port, encodedVhost, rabbitMQSnifferProp)
    ...
    private fun Channel.publish(replyTo: String): Channel {
        ...
        basicPublish(exchange, routingKey, AMQP.BasicProperties().builder()
                .replyTo(replyTo)
