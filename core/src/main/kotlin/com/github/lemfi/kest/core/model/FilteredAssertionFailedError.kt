...
class FilteredAssertionFailedError(message: String?, expected: Any?, actual: Any?, throwable: Throwable? = null): AssertionFailedError(message, expected, actual, throwable) {
