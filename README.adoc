...
[source,kotlin]
----
    implementation("com.github.lemfi.kest:core:0.6.2")
    implementation("com.github.lemfi.kest:junit5:0.6.2")

    // include the steps you need among available ones
    implementation("com.github.lemfi.kest:step-http:0.6.2")
    implementation("com.github.lemfi.kest:step-cadence:0.6.2")
    implementation("com.github.lemfi.kest:step-mongodb:0.6.2")
    implementation("com.github.lemfi.kest:step-rabbitmq:0.6.2")
    implementation("com.github.lemfi.kest:step-redis:0.6.2")

    // toolbox for Json Data
    implementation("com.github.lemfi.kest:json:0.6.2")
