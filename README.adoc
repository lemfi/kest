...
[source, kotlin]
----
    implementation("com.github.lemfi.kest:core:0.0.11")
    implementation("com.github.lemfi.kest:junit5:0.0.11")

    // include the steps you need among available ones
    implementation("com.github.lemfi.kest:step-http:0.0.11")
----
=== Maven
[source, xml]
----
