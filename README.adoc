...
[source, kotlin]
----
    implementation("com.github.lemfi.kest:core:0.0.9")
    implementation("com.github.lemfi.kest:junit5:0.0.9")

    // include the steps you need among available ones
    implementation("com.github.lemfi.kest:step-http:0.0.9")
----
=== Maven
[source, xml]
----
...
If step contains a withResult() function, this function is executed after step assertions have passed.
